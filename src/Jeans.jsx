...
export default function Jeans(){
    ...
    <div className="container d-flex justify-content-start align-items-center  flex-wrap product-container">
    { jeansdata.map((element,index)=>{
        return(
